	...
	<Card>
		...
		<Content>
			<div class="flex flex-row items-center">
				<p class="font-body font-bold text-xl w-[15%]">Cannabis</p>
				<p class="font-body text-xl">
					{getAnswer(habitsOptions.cannabis, $habits.cannabis)}
				</p>
			</div>
			<div class="flex flex-row items-center mt-4">
				<p class="font-body font-bold text-xl w-[15%]">Smoking</p>
				<p class="font-body text-xl">
					{getAnswer(habitsOptions.smoking, $habits.smoking)}
				</p>
			</div>
			<div class="flex flex-row items-center mt-4">
				<p class="font-body font-bold text-xl w-[15%]">Alcohol</p>
				<p class="font-body text-xl">
					{getAnswer(habitsOptions.alcohol, $habits.alcohol)}
				</p>
			</div>
			<div class="flex flex-row items-center mt-4">
				<p class="font-body font-bold text-xl w-[15%]">Exercise</p>

...
<CollapsibleCard title="Your Menopausal Mood Symptoms">
	<Image>
		<img
			class="max-w-[250px]"
	...
	<SubSection title="Addressing Mood Concerns">
		<Paragraph>
			...
			For women experiencing both VMS and mood symptoms, MHT can be helpful. There is also evidence for
			regular exercise and mindfulness-based therapies to improve mood.
		</Paragraph>
	</SubSection>
</CollapsibleCard>

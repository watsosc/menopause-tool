...
<Card>
	<EducationTitleBar>Your Vasomotor Symptoms</EducationTitleBar>
	<Content>
		<Image>
		...
		<Paragraph>
			<b>
				About 20% of women experiencing hot flashes will have severe symptoms with 20-30 episodes
				per day.
			</b>
			The cause of vasomotor symptoms is not well understood but has to do with estrogen’s effect on
		...
		{#if $medication.medicationSelection.includes('thyroid')}
			<Paragraph customized>
				...
				and worsen hot flashes and night sweats. It is important to have your thyroid levels checked
				with your doctor and make sure you have the right medication dose.
			</Paragraph>
		{/if}
		...
		<SubSection title="Treating Vasomotor Symptoms">
			...
			{#if Number($bmi) > 25}
				<Paragraph customized>
					...
					other chronic medical conditions. Women should strive to eat a diet high in protein, fibre
					and fruits and vegetables. Fats should be unsaturated, and sodium should be limited to 1300
					mg per day. Women should ensure adequate calcium in their diets (1200 mg/day) as well as take
					a vitamin D supplement (800-2000 IU daily).
				</Paragraph>
			{/if}
			<Paragraph>
				There have been some studies indicating that <b>paced respiration</b> may be of some benefit
				for people with vasomotor symptoms, although the evidence is not strong.
			</Paragraph>
			...
			<Paragraph>
				The safety and efficacy of bioidentical products have not been tested with the same rigour
				as approved pharmaceutical options for treatment of vasomotor symptoms and are <b>
					not recommended
				</b>
				by Health Canada.
			</Paragraph>
			...
			<div class="pl-4">
				...
				<Paragraph>
					<b>
						Some antidepressant medications can help reduce the frequency and severity of hot
						flashes by 27-61%.
					...
					insomnia and nervousness. Selective Serotonin Reuptake Inhibitors (SSRI) medications (such
					as paroxetine, citalopram and escitalopram) can worsen vasomotor symptoms at high doses.
				</Paragraph>
				...
				<Paragraph>
					<ol class="list-decimal ml-6">
						...
						<li class="pt-2">
							...
							hot flashes and night sweats. Side effects include dry eyes, blurred vision, dry mouth,
							constipation and it can have an effect on brain function in older women. Talk to your doctor
			...
			{#if !takingTamoxifen}
				{#if $treatment.current.includes('contraceptive')}
					<Paragraph customized>
						...
						contain higher amounts of hormones and, as you age, it will be safer to consider a switch
						to MHT or a non-hormonal option. Speak to your doctor about the best option for you.
					</Paragraph>
				{/if}
				{#if $basics.bleeding === 'yes'}
					<Paragraph customized>
						...
						or cancer. It is important that you speak to your doctor about this, as they will likely
						suggest investigations to rule out these worrisome causes. If you have already had these
						investigations and your doctor is not worried about any abnormalities, you may be able to
						consider MHT.
					</Paragraph>
				{/if}
				{#if Number($basics.age) > 60}
					<Paragraph customized>
						...
						after the age of 60 carries greater risk, and may not be a suitable treatment option for
						you.
					</Paragraph>
					{#if $treatment.current.includes('hormone')}
						<Paragraph customized>
							<b>You have indicated that you are over the age of 60 and currently taking MHT.</b> It
							is important to review your medications and risk profile with your healthcare provider,
							as the risks of MHT can increase as women age.
						</Paragraph>
					{/if}
				{/if}
			{/if}
			{#if $basics.period === 'ten-year'}
				<Paragraph customized>
					...
					treatments that might be better for you.
				</Paragraph>
				{#if $treatment.current.includes('hormone')}
					<Paragraph customized>
						<b>
						...
						It is important to review your medications and personal risk profile with your healthcare
						provider, as the risks of MHT increase when someone is more than 10 years from their final
						menstrual period.
					</Paragraph>
				{/if}
			{/if}
			...
			{#if $history.conditions.includes('liver-disease')}
				<Paragraph customized>
					...
					MHT is not recommended for people with a history of significant liver disease.
				</Paragraph>
			{/if}
			{#if !hideMht}
				...
				{#if $history.conditions.includes('migraine') || $medication.medicationSelection.includes('migraine')}
					<Paragraph customized>
						...
						pros and cons of using MHT with your healthcare provider. If you choose to use MHT, it is
						best to start with a very low dose to ensure there is no increase in the frequency or severity
						of your migraines.
					</Paragraph>
				{/if}
				{#if $history.conditions.includes('other-cancer')}
					<Paragraph customized>
						<b>
							You have indicated that you have a history of a cancer other than breast, endometrial
							or ovarian cancer.
						</b>
						Generally speaking, MHT can be used by people who have a history of cancers other than the
						types just mentioned. It is still important to discuss the risks and benefits of MHT with
				...
				{#if $habits.smoking === 'yes'}
					<Paragraph customized>
						...
						while taking menopausal hormone therapy. Speak to your doctor about whether MHT is right
						for you and which route of administration might be best.
					</Paragraph>
				{/if}
				...
				{:else if $genetics.family.includes('ovarian-cancer')}
					<Paragraph customized>
						...
						Ovarian and breast cancers can sometimes be related. Your baseline risk of breast cancer
						may be higher than someone without a family history of ovarian cancer. Speak to your doctor
				...
				{#if ($genetics.genes.includes('brca1') || $genetics.genes.includes('brca2')) && $surgeries.ovariesRemoved === 'yes'}
					<Paragraph customized>
						...
						age of menopause (51) and have had a risk-reducing salpingo-oophorectomy (removal of your
				...
				{#if $genetics.family.includes('stroke')}
					<Paragraph customized>
						...
						This could indicate that you are at higher risk of stroke than the average person. MHT is
						still a treatment option for you, however using a transdermal estrogen may help to lower
						your risk with MHT. Speak to your doctor about the MHT option that is best for you.
					</Paragraph>
				{/if}
				{#if $genetics.family.includes('heart')}
					<Paragraph customized>
						<b>You have indicated that you have a family history of heart attack.</b>
						This could indicate that you are at higher risk of heart attack than the average person.
						MHT is still a treatment option for you, however using a transdermal estrogen may help to
						lower your risk with MHT. Speak to your doctor about what is best for you.
					</Paragraph>
				{/if}
				...
				<Paragraph>
					...
					increased risk of breast cancer for women on MHT is similar to other risk factors for
					breast cancer, such as drinking more than 2 alcoholic beverages per day, obesity, starting
					your periods before the age of 12, or entering menopause after the age of 55.
				</Paragraph>
				<Paragraph>
				...
				<Paragraph>
					...
					increase it in order to manage your symptoms. Higher starter doses may be needed for
					younger women. Most women will begin to see an effect of the medications within 2-6 weeks.
				</Paragraph>
				{#if $surgeries.received.includes('hysterectomy')}
					<Paragraph customized>
						<b>You have indicated that you have had a hysterectomy (removal of the uterus).</b>
						For women who have previously had a total hysterectomy, only estrogen is required. If you
						are unsure about whether you had a total (your cervix was removed as part of the operation)
						or subtotal (your cervix was not removed) it is important you clarify this with your doctor.
						In some circumstances, women with a previous hysterectomy may still benefit from being on
						progesterone at the same time. Speak to your doctor about what is best for you.
					</Paragraph>
				...
				<div class="px-4">
					...
					<Paragraph>
						...
						pill every day) or cyclically (meaning you take a pill on certain days per month).
						Cyclic regimens are usually selected for younger women and women at higher risk of
						breast cancer. Women on a cyclic regimen can expect to have scheduled bleeding each
						month. Speak to your healthcare provider about which option is best for you.
					</Paragraph>
					<Paragraph>
					...
					{#if ($basics.period === 'regular' || $basics.period === 'irregular') && !$medication.medicationSelection.includes('menopause')}
						<Paragraph customized>
							...
							means you will take progesterone approximately 12 days per month. This typically
							allows you to have a “progesterone withdrawal bleed” each month. This is a simulated
							period allowing you to shed any lining that has built up inside the uterus. Cyclic
							progesterone will likely reduce your rate of unscheduled bleeding. At some point, your
					...
					{:else if $basics.period === 'one-year' && !$surgeries.received.includes('hysterectomy')}
						<Paragraph customized>
							...
							Your doctor may suggest you take your progesterone <b>continuously</b>. While it can
							be common to have breakthrough bleeding in the first 6 months of a Combined
					...
					<Paragraph>
						<b>
							...
							Canada are shown in the Table below. Talk to your doctor about which one may be right
							for you.
						</b>
					</Paragraph>

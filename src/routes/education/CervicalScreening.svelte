		...
		<Content>
			...
			<Paragraph>
				<b>
					...
					cells of the cervix. Regular pap tests can facilitate early detection of abnormal cells in
					the cervix.
				</b>
			</Paragraph>
			{#if ovariesRemoved}
			...
			{:else if underSeventy && $screening.pap === 'three-years'}
				<Paragraph customized>
					<b>
						You have indicated that you are younger than 70 years old and your pap test was within
						the last 3 years.
					</b>
			...
			{:else if !underSeventy && $screening.pap === 'not-required'}
				<Paragraph customized>
					...
					However, if you have had an abnormal pap test result in the past 10 years, you may require
					screening beyond the age of 70.
				</Paragraph>
				<Paragraph>{postParagraph}</Paragraph>
			{/if}
		</Content>

...
<div class="container mx-auto px-4">
	<CollapsibleCard title="Breast Screening">
		<Image>
		...
		{#if breastCancerPersonal}
			<Paragraph customized>
				...
				Your doctor has likely discussed how to complete breast surveillance moving forward. If you are
				unsure, speak to your healthcare provider about breast screening recommendations that are right
				for you.
			</Paragraph>
		...
		{:else if !breastCancerPersonal && ovarianCancerFamily}
			<Paragraph customized>
				{@html screeningParagraphBold}
				<br /> <br />
				<b> You have indicated you have a family history of ovarian cancer. </b> Ovarian cancer and breast
				cancer can sometimes be related. Speak to your doctor about breast screening recommendations
				that are right for you.
			</Paragraph>
		{:else if !(cancerFamily || breastCancerPersonal) && $genetics.genes.some( (gene) => ['brca1', 'brca2'].includes(gene) )}
			<Paragraph customized>
				<b>
					You have indicated you carry a gene that may increase your risk of breast cancer compared
					to someone without this gene.
				</b>
				If you have not already discussed breast screening, speak to your doctor about recommendations
				that are right for you.
			</Paragraph>
		{:else if cancerFamily && !breastCancerPersonal && $genetics.genes.some( (gene) => ['brca1', 'brca2'].includes(gene) )}
			<Paragraph customized>
				...
				<b>
					You have indicated you carry a gene that may increase your risk of breast cancer compared
					to someone without this gene. You have also indicated you have a family history of breast
					or ovarian cancer.
				</b>
				If you have not already discussed breast screening, speak to your doctor about recommendations
				that are right for you.
		...
		{:else if $screening.mammogram === 'young' && !(cancerFamily || breastCancerPersonal)}
			<Paragraph customized>
				<b>
					You have indicated that you have not had a mammogram before, and you are aged 50 or older.
				</b>
		...
		{:else if $screening.mammogram === 'last-year' && !(cancerFamily || breastCancerPersonal)}
			<Paragraph customized>
				...
				You are likely up-to-date on your breast cancer screening. However, some people may require more
				frequent screening.
				<br /> <br />
				{@html screeningParagraph}
			</Paragraph>
		{:else if $screening.mammogram === 'two-year' && !(cancerFamily || breastCancerPersonal)}
			<Paragraph customized>
				...
				You are likely up-to-date on your breast cancer screening. However, some people may require more
				frequent screening. You should speak to your healthcare provider about arranging your next mammogram.
				<br /> <br />
				{@html screeningParagraph}
			</Paragraph>

	...
	<Card>
		...
		<Content>
			...
			<Paragraph customized>
				...
				<br /> <br />
				<b>
					Smoking can also increase the risks associated with using menopausal hormone therapy
					(MHT).
				</b>
				For example, a smoker who takes menopausal hormone therapy has a higher risk of heart attack,
				...
				If you are ready to quit smoking, speak to your healthcare provider about support and resources
